...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "RestoBooking.MobileClient.Android.dll" comes first in this list. */
		"RestoBooking.MobileClient.Android.dll",
		"FormsViewGroup.dll",
		"RestoBooking.MobileClient.dll",
